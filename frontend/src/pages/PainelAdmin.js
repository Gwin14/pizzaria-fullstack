...
function PainelAdmin() {
  ...
  const [mostrarMaisCarrinho, setMostrarMaisCarrinho] = useState(null); // 👈 novo estado
  ...
  return (
    <div className="pizzeria-container">
      ...
      <div className="pizzeria-admin-grid">
        ...
        <div className="pizzeria-admin-card">
          ...
          <div style={{ overflowX: "auto" }}>
            <table className="pizzeria-table" style={{ margin: 0 }}>
              ...
              <tbody>
                {carrinhos.map((c) => {
                  const mostrarTodos = mostrarMaisCarrinho === c.id;
                  const itensParaMostrar = mostrarTodos
                    ? c.itens
                    : (c.itens || []).slice(0, 2);
                        ...
                        <div style={{ display: "grid", gap: "5px" }}>
                          ...
                          {(c.itens?.length || 0) > 2 && (
                            <button
                              ...
                              onClick={() =>
                                setMostrarMaisCarrinho(
                                  mostrarTodos ? null : c.id
                                )
                              }
                            >
                              {mostrarTodos
        ...
        {/* Pedidos (sem alteração por enquanto) */}
        <div className="pizzeria-admin-card">
          <div className="pizzeria-admin-header">
